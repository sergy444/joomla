...
$css.="#inner".$modno."{background:".$colour1." url(".$url."/modules/mod_topcloud250/tmpl/images/backgrounds/".$bgpattern.");padding:5px;border:".$bordersz."px solid ".$bordercol.";border-radius:".(ceil($bordersz*1.4))."px;box-shadow:0 0 ".$shadsz."px ".$shadcol.";}";}
$css.="
    /* TopCloud250 Ends */
    ";
