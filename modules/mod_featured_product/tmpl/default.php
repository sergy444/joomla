...
$document->addStyleSheet(JURI::base().'modules/mod_featured_product/css/featured_prd.css'); 	
$document->addScript(JURI::base().'modules/mod_featured_product/js/bxslider.js'); 
...
<div class="block block-featured">
           ...
           <ul class="products-grid bxslider" id="block-featured">
    <?php
             ...
             <div class="product-name">
              ...
              <div class="additionnal">
                ...
                <input type="text" class="quantity-input fea_qua" name="quantity[]" value="1"/>
                 ...
                 <a class="addtocart">
                        <input type="submit" value="<?php echo $button_lbl ?>" name="addtocart"  class="addtocart-button category_cart_btn" title="<?php echo $button_lbl ?>" /></a>
  ...
  <?php }
    ...
    noconf(document).ready(function(){
        ...
        var related_slider = noconf('#block-featured').bxSlider({
            minSlides: 1,
