...
$vm_cart_empy	= $params->get('vm_cart_empy', '<span id="cartHeader">0 item(s)<span class="for-desktop">&nbsp;- <span class="price">$0.00</span></span></span>');
$margin_top = (int)$params->get("popup_top", 150);
//$document->addCustomTag('<style type="text/css"> #facebox { top: '.$margin_top.'px } </style>');
