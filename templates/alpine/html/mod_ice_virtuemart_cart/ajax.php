...
if (!defined ('_JEXEC')) {
	...
	$data->billTotal = $lang->_('COM_VIRTUEMART_CART_TOTAL').' : '. $data->billTotal .'';
	$tmp = $tmp2 = array();
	...
	<div class="lof_vm_bottom" style="display:none;">
		...
		<div class="lof_item">
			...
			<div class="lof_info">
				...
				<span class="lof_quantity"><?php echo  $product['quantity'] ?></span> * <span class="lof_price"> <?php echo  $product['prices'] ?></span>
