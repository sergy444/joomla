...
<form method="post" id="userForm" name="chooseShipmentRate" action="<?php echo JRoute::_('index.php'); ?>" class="form-validate">
    ...
    <div class="mybutton medium">
	     <button  name="setshipment" class="<?php echo $buttonclass ?>" type="submit" ><span data-hover="<?php echo JText::_('COM_VIRTUEMART_SAVE'); ?>" ><?php echo JText::_('COM_VIRTUEMART_SAVE'); ?></span></button>  &nbsp;
		<?php   if ($this->layoutName!='default') { ?>
		<button class="<?php echo $buttonclass ?>" type="reset" onClick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=cart'); ?>'" ><span data-hover="<?php echo JText::_('COM_VIRTUEMART_CANCEL'); ?>" ><?php echo JText::_('COM_VIRTUEMART_CANCEL'); ?></span></button>
		<?php  } ?>
        </div>
	</div>
