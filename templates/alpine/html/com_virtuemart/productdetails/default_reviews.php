...
if ($this->allowRating || $this->showReview) {
	...
	<div class="customer-reviews_acr">
...
if ($this->showReview) {
	...
	?>
	<?php /*?><h4><?php echo JText::_ ('COM_VIRTUEMART_REVIEWS') ?></h4><?php */?>
...
//]]>
			...
			if ($review_editable) {
				...
				<br/><br/>
				<input class="highlight-button sub_review" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>" value="<?php echo JText::_ ('COM_VIRTUEMART_REVIEW_SUBMIT')  ?>"/>
				<?php
			} else {
