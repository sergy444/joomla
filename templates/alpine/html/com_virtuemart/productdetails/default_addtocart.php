...
<script type="text/javascript">
		...
		<?php // Display the quantity box
			...
			if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($this->product->product_in_stock - $this->product->product_ordered) < 1) {
				...
				if (!( VmConfig::get('askprice', 0) and empty($tmpPrice) ) ) {
					...
					<span class="quantity-box">
						<input type="text" id="qty" class="quantity-input js-recalculate" name="quantity[]" onblur="check(this);"
					...
					<input type="button" class="quantity-controls quantity-plus" value="click here" />
					<input type="button" class="quantity-controls quantity-minus" value="click here" />
					</span>
            ...
            <ul class="add-to-links">
				<li>
         			  <a class="link-wishlist" onclick="AddToWishlist('<?php echo $this->product->virtuemart_product_id; ?>','<?php echo $this->product->virtuemart_category_id; ?>')"><i class="fa fa-heart-o"></i>&nbsp;Add to Wishlist</a>
               </li>
			    <li>
                	
                     <a class="link-compare" title="Add to Comapre" onclick="AddToCompare('<?php echo  $this->product->virtuemart_product_id; ?>','<?php echo  $this->product->virtuemart_category_id; ?>')"><i class="fa fa-files-o"></i>&nbsp;Add to Comapre</a>
               </li>
