...
?>
<div class="product-price price_details" id="productPrice<?php echo $this->product->virtuemart_product_id ?>">
	<?php
	if (!empty($this->product->prices['salesPrice'])) {
		echo "<div class='price_tag'>" . JText::_ ('COM_VIRTUEMART_CART_PRICE') . "</div>";
	}
